...
export function FeatureThree({
  title = "Monitor Your Fleet from One Command Center",
  description = "Your AEGIS Dashboard consolidates a suite of performance metrics to surface your scores, track opponent intelligence, and visualize the full battle history from leaderboard to detailed run breakdown, automatically.",
