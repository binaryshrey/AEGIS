...
export function FeatureTwo({
  title = "Deploy Your Agent Fleet, Watch a Live Battle",
  description = "Launch into a live battle arena, stream real-time events and let AEGIS AI execute an end-to-end combat workflow that adapts its strategy across every opponent game by game, fully autonomous.",
  imageSrc = "/arena.webp",
  linkText = "Learn more",
