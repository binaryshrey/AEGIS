            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                <AnimatedGroup variants={transitionVariants}>
                  <Link
                    href="https://challenge.starsling.dev/"
                    target="_blank"
                ...
                <TextEffect
                  ...
                  speedSegment={0.3}
                  as="h1"
                  className="mx-auto mt-8 max-w-4xl text-balance text-5xl max-md:font-semibold md:text-7xl lg:mt-16 xl:text-[5.25rem] dark:text-white"
                >
                  Closed-Loop Agent Challenge
                </TextEffect>
                <TextEffect
                  per="line"
                  preset="fade-in-blur"
                  ...
                  delay={0.5}
                  as="p"
                  className="mx-auto mt-8 max-w-2xl text-balance text-lg dark:text-gray-300"
                >
                  AEGIS is an autonomous battleship agent that detects opponent
                  patterns, exploits them via Thompson Sampling and climbs the
                  leaderboard faster every game.
                </TextEffect>
